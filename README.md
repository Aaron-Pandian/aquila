...
This project is currently under active development. The infrastructure is operational, and work has shifted to the algorithmic implementation of the autonomy stack. Key updates to the PX4 repository are hidden for now. 
